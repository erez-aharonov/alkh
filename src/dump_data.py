...
def take_it_offline(notebook_dir_path: Optional[str] = None):
    ...
    notebook = _create_notebook_object(stack_df, pickle_file_name)
    nbf.write(notebook, notebook_path)


def _create_notebook_object(stack_df, pickle_file_name):
    notebook = nbf.v4.new_notebook()
    intro_markdown = nbf.v4.new_markdown_cell("# Generated by alkh")
    import_pandas = nbf.v4.new_code_cell("import pandas as pd")
...
stack_df[["file_path", "function", "lineno", "locals_names"]]"""
    ...
    cells_list = [intro_markdown, import_pandas, read_pickle_and_display] + stack_cells
