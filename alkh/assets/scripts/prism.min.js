        ...
        var t = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i,
            ...
            r = {
                ...
                highlightElement: function(t, a, n) {
                    ...
                    function u(e) {
                        o.highlightedCode = e, r.hooks.run("before-insert", o), o.element.innerHTML = o.highlightedCode, r.hooks.run("after-highlight", o), r.hooks.run("complete", o), n && n.call(o.element)
                    }
                    if (r.hooks.run("before-sanity-check", o), (l = o.element.parentElement) && "pre" === l.nodeName.toLowerCase() && !l.hasAttribute("tabindex") && l.setAttribute("tabindex", "0"), !o.code) return r.hooks.run("complete", o), void(n && n.call(o.element));
                ...
                tokenize: function(e, t) {
                    ...
                    var r = new o;
                    return u(r, r.head, e), l(e, r, t, r.head, 0),
                        function(e) {
                            var t = [],
                                a = e.head.next;
            ...
            for (var d in a)
                if (a.hasOwnProperty(d) && a[d]) {
                    ...
                    for (var m = 0; m < p.length; ++m) {
                        ...
                        for (var x = h.pattern || h, k = n.next, w = o; k !== t.tail && !(c && w >= c.reach); w += k.value.length, k = k.next) {
                            var A = k.value;
                            ...
                            if (!(A instanceof s)) {
                                ...
                                if (L && (T = u(t, T, L), w += L.length), g(t, T, $), k = u(t, T, new s(d, f ? r.tokenize(C, f) : C, y, C)), z && u(t, k, z), $ > 1) {
                                    ...
                                    l(e, t, a, k.prev, w, M), c && M.reach > c.reach && (c.reach = M.reach)
                                }
                            }
                        }
                    }
                    ...
                    c && c.loadLanguages(u),
                        function(e, t, a) {
                            ...
                            if (a) {
                                ...
                                s < 0 && (s += r.length), s = Math.max(0, Math.min(s - 1, r.length)), o < 0 && (o += r.length), o = Math.max(0, Math.min(o, r.length)), e = r.slice(s, o).join("\n"), i.hasAttribute("data-start") || i.setAttribute("data-start", String(s + 1))
                            }
